...
bottom_panel = 35
SCREEN_WIDTH = 800
SCREEN_HEIGHT = SCREEN_HEIGHT = int(SCREEN_WIDTH * 0.7) + bottom_panel
LOWER_MARGIN = 100
SIDE_MARGIN = 300
...
#load images
lava_img = pygame.image.load('img/Background/ludi.jpg').convert_alpha()
lava_img = pygame.transform.scale(lava_img,(SCREEN_WIDTH * 1.2,SCREEN_HEIGHT ))
...
def draw_bg(img):
	...
	width = img.get_width()
	for x in range(10):
		screen.blit(img, ((x * width) - scroll * 0.5, 0))
